...
#id we make more hidden layer then it may becomes ratto tota because it pourly understad traing but fails in test data 
classifier.add(Dense(units = 6, kernel_initializer = 'uniform', activation = 'relu'))

# Adding the outputlayer
classifier.add(Dense(units = 1, kernel_initializer = 'uniform', activation = 'sigmoid'))
#in output always use sigmoid function and not in regresiion any type of function at output
#and any type of classification not takes any algo in input layesrs
# Compiling the ANN
...
#batch size =10 means it convet 8000 into 10 part and data is also gives in 10 eiteration(epoch)
