...
plt.plot(ages_x,dev_y,label='Developer',marker='o',color='black')
plt.xlabel("ages of developer")
plt.ylabel("Avergae salary of the Developer")

plt.plot(ages_x,py_dev_y,label='Python Developer',marker='s')

plt.plot(ages_x,js_dev_y,label='JavaScript Developer',marker='d')
plt.title("stackOverflow developer anual saleries")
plt.legend()
plt.show()
